...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Logements NYC — Logements entre Français à New York" },
      {
        property: "og:description",
        content: "Le site des Français qui cherchent ou proposent un logement à New York.",
      },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://www.logements.nyc" },
      ...
      { property: "og:image", content: "https://www.logements.nyc/__l5e/assets-v1/df87158d-00d9-4fa0-82b3-97d2f9fa4a0b/og-image.png" },
      { name: "twitter:image", content: "https://www.logements.nyc/__l5e/assets-v1/df87158d-00d9-4fa0-82b3-97d2f9fa4a0b/og-image.png" },
    ],
    links: [
